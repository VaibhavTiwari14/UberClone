...
const Logo = () => {
  ...
  return (
    <div
      onClick={gotoMain}
      className="group cursor-pointer transform transition-all duration-300 hover:scale-105 h-full min-h-[40px] flex items-center"
    >
      <div className="flex flex-col items-center md:flex-row md:items-center h-full">
        <h1
          className="text-3xl md:text-4xl font-extrabold tracking-wide flex items-center h-full"
          style={{
            fontFamily:
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-yellow-400/20 to-amber-500/20 backdrop-blur-md border border-yellow-400/30 rounded-full px-6 py-2 shadow-[0_8px_32px_rgba(251,191,36,0.15)] hover:shadow-[0_12px_40px_rgba(251,191,36,0.25)] transition-all duration-300 flex items-center">
            <span
