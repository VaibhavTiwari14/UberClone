            ...
            <div className="max-w-lg text-white text-center">
              ...
              <div className="mb-6">
                ...
                <p className="text-base text-gray-300 mb-6 leading-relaxed">
                  Experience the future of transportation with instant bookings, real-time tracking, and rides that fit your lifestyle.
        </p>
      </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 bg-yellow-400/10 p-3 rounded-xl backdrop-blur-sm border border-yellow-400/20">
                  ...
                  <div className="text-left">
                    <h3 className="font-bold text-sm text-white">Instant Booking</h3>
                    <p className="text-xs text-gray-300">Get a ride in under 2 minutes</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 bg-yellow-400/10 p-3 rounded-xl backdrop-blur-sm border border-yellow-400/20">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-300">Know exactly where your ride is</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 bg-yellow-400/10 p-3 rounded-xl backdrop-blur-sm border border-yellow-400/20">
                  ...
                  <div className="text-left">
                    <h3 className="font-bold text-sm text-white">Fair Pricing</h3>
                    <p className="text-xs text-gray-300">Transparent rates, no surprises</p>
                  </div>
                </div>
              </div>
