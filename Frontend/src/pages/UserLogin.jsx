            ...
            <div className="space-y-4 bg-black/30 backdrop-blur-md p-6 rounded-2xl border border-yellow-400/20">
              ...
              <div className="flex justify-center mb-4 w-full">
                ...
                >
                  ...
                  <span className="font-medium text-sm">Switch to Captain</span>
                </Link>
              </div>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  style={{ cursor: loading ? "not-allowed" : "pointer" }}
                >
                  {loading ? "Loading..." : "Start Your Ride"}
                </button>
              </div>
            ...
            <div className="max-w-lg text-white text-center">
              ...
              <div className="mb-6">
                ...
                <p className="text-base text-gray-300 mb-6 leading-relaxed">
                  Experience the future of transportation with instant bookings,
                  real-time tracking, and rides that fit your lifestyle.
                </p>
              </div>
