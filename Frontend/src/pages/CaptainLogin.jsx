            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-200">
                  New to Taxi-Go?{' '}
                  <a href="/captain-signup" className="text-yellow-400 hover:text-yellow-300 font-semibold transition-colors">
                    Start Your Journey
                  </a>
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <Link to={"/user-login"} className="flex items-center justify-center px-3 py-2 border-2 border-yellow-400 rounded-lg bg-black/50 hover:bg-black/70 transition-all duration-200 group">
                  <svg className="w-4 h-4 mr-2 text-yellow-400 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                  </svg>
                  <span className="text-white font-medium text-sm">Rider</span>
                </Link>
                
                <Link to={"/captain-login"} className="flex items-center justify-center px-3 py-2 border-2 border-yellow-400 rounded-lg bg-black/50 hover:bg-black/70 transition-all duration-200 group">
                  <svg className="w-4 h-4 mr-2 text-yellow-400 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12a3 3 0 006 0m0 0V9a3 3 0 00-6 0v3m0 0a3 3 0 006 0"/>
                  </svg>
                  <span className="text-white font-medium text-sm">Captain</span>
                </Link>
              </div>

              {/* Social Login */}
              <div className="space-y-2">
                <button className="w-full flex items-center justify-center px-3 py-2 border border-yellow-400 rounded-lg bg-black/50 hover:bg-black/70 transition-all duration-200">
              ...
              <div className="space-y-3">
                <div>
                  <label htmlFor="email" className="block text-xs font-semibold text-yellow-400 mb-1">
                    Email Address
                  </label>
                  <div className="relative">
                    <input
                    ...
                    />
                    <svg className="w-4 h-4 text-yellow-400 absolute left-3 top-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <label htmlFor="password" className="block text-xs font-semibold text-yellow-400">
                      Password
                    </label>
                    <a href="/forgot-password" className="text-xs text-yellow-400 hover:text-yellow-300 font-medium transition-colors">
                      Forgot password?
                    </a>
                  </div>
                  <div className="relative">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-black/50 backdrop-blur-sm relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-20">
            <svg className="w-full h-full" viewBox="0 0 200 200" preserveAspectRatio="none">
              <defs>
                <pattern id="taxi-pattern" width="40" height="40" patternUnits="userSpaceOnUse">
                  <rect width="40" height="40" fill="none"/>
                  <circle cx="20" cy="20" r="2" fill="white" opacity="0.3"/>
                  <path d="M10 10 L30 30 M30 10 L10 30" stroke="white" strokeWidth="0.5" opacity="0.2"/>
                </pattern>
              </defs>
              ...
              <div className="mb-6">
                <div className="w-24 h-24 bg-yellow-400/20 rounded-2xl mx-auto mb-4 flex items-center justify-center backdrop-blur-sm">
                  <svg className="w-12 h-12 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 17l6-6-6-6"/>
                  </svg>
                </div>
                ...
                <p className="text-base text-gray-300 mb-6 leading-relaxed">
                  Join our network of professional drivers. Set your own schedule, earn competitive rates, and be your own boss.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 bg-yellow-400/10 p-3 rounded-xl backdrop-blur-sm border border-yellow-400/20">
                  ...
                  <div className="text-left">
                    <h3 className="font-bold text-sm text-white">Flexible Hours</h3>
                    <p className="text-xs text-gray-300">Drive when you want, earn what you want</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 bg-yellow-400/10 p-3 rounded-xl backdrop-blur-sm border border-yellow-400/20">
                  ...
                  <div className="text-left">
                    <h3 className="font-bold text-sm text-white">Weekly Payments</h3>
                    <p className="text-xs text-gray-300">Get paid weekly, no delays</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 bg-yellow-400/10 p-3 rounded-xl backdrop-blur-sm border border-yellow-400/20">
                  ...
                  <div className="text-left">
                    <h3 className="font-bold text-sm text-white">24/7 Support</h3>
                    <p className="text-xs text-gray-300">Help whenever you need it</p>
                  </div>
                </div>
              </div>
